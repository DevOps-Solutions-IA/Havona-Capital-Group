...
const definition = (
  ...
  meaning: criteria,
  source,
  dimensions: ['consultant', 'team', 'source', 'stage', 'channel', ...additionalDimensions],
...
export const METRIC_CATALOG = [
  ...
  definition(
    ...
    ['customerNeed', 'authorizedSolution', 'authorizedProduct'],
  ),
  definition(
    'sales.weighted_pipeline',
    'Pipeline ponderado',
    'CURRENCY',
    ['opportunities.amount', 'opportunities.probability', 'opportunities.currency'],
    'Suma de amount × probability/100 para oportunidades OPEN con ambos campos, agrupada por moneda.',
  ),
  definition(
    'sales.won_value',
    'Valor comercial ganado',
    'CURRENCY',
    [
    ...
    'Suma del valor comercial estimado de oportunidades WON cerradas en [start,end); no representa ingreso contable.',
  ),
  definition(
    ...
    'Suma del valor potencial de oportunidades LOST; no representa pérdida contable.',
  ),
  definition(
    ...
    'CURRENCY',
    ['opportunities.amount', 'opportunities.currency', 'opportunities.status'],
    'Promedio de amount para oportunidades WON con monto, agrupado por moneda.',
  ),
  definition(
    'sales.median_deal_value',
    'Ticket mediano ganado',
    'CURRENCY',
    ['opportunities.amount', 'opportunities.currency', 'opportunities.status'],
    'Mediana de amount para oportunidades WON con monto, agrupada por moneda.',
  ),
  definition(
    ...
    'Valor de oportunidades OPEN declaradas COMMIT cuya fecha esperada cae en el periodo; no garantiza cierre.',
  ),
  definition(
    'sales.financial_coverage',
    ...
    'Completitud de campos financieros en oportunidades abiertas.',
  ),
  definition(
